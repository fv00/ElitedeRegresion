...
Según el criterio del $R^2_{adj}$ y el principio de parcimonia, se elige el modelo con indice 163 en la tabla de todos los modelos de regresión, ya que el crecimiento en el $R^2_{adj}$ no es tan grande al añadir más de 5 variables. 

El modelo con 5 covariables que tiene el $R^2_{adj}$ más alto, es el modelo que está compuesto de las covariables "EDAD RINF RRX NCAMAS PDP"
```{r}
